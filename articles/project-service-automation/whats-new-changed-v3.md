...
1.  Deoarece **Resursa care se poate rezerva**, care este un câmp în entitatea **Intrare de timp** nu este expusă pe pagina **Creare rapidă**, trebuie să o adăugați.
    ...
    Creați o vizualizare particularizată pentru a vizualiza numai intrările de timp create pentru resursă. Publicați particularizările de pe proiectantul modulului aplicației pentru ca această vizualizare să apară sub **Vizualizare selector** pe pagina **Intrări de timp**. Există două inserturi care se ocupă de setarea managerului pentru intrările de timp non-proiect:
