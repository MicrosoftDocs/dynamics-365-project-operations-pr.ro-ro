...
## <a name="using-journals-to-record-costs"></a>Utilizarea jurnalelor pentru înregistrarea costurilor

În PSA, jurnalele vă permit să înregistrați costuri sau venituri în clasele de tranzacții Materiale, Tarife, Timp, Cheltuieli sau Taxe. Un jurnal are un antet, linii și o acțiune **Confirmare**. Iată câteva scenarii în care este posibil să utilizați un jurnal:
