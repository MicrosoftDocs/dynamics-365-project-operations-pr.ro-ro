...
- [Proiect](../developer/entities/msdyn_project.md)
- [Echipă de proiect](../developer/entities/msdyn_projectteam.md)
- [Sarcina proiectului](../developer/entities/msdyn_projecttask.md)
- [Atribuiri de resurse](../developer/entities/msdyn_resourceassignment.md)
- [Dependența sarcinii proiectului](../developer/entities/msdyn_projecttaskdependency.md)
- [Resurse ce se pot rezerva](../developer/entities/bookableresource.md)

Pentru a defini o resursă încărcată în structura detaliată a proiectului, trebuie să parcurgeți următorii pași:

1. Creați un nou proiect. Pentru mai multe informații despre modul de creare a unui proiect nou, consultați [msdyn_project](../developer/entities/msdyn_project.md).
2. Creați una sau mai multe activități. Pentru mai multe informații despre modul de creare a unei activități, consultați [msdyn_projecttask](../developer/entities/msdyn_projecttask.md).
3. Definiți dependențele de activitate. Pentru informații suplimentare, consultați [Dependența sarcinilor de proiect](../developer/entities/msdyn_projecttaskdependency.md).
4. Atribuiți membri de echipă de proiect la proiect. Pentru mai multe informații, consultați [msdyn_projectteam](../developer/entities/msdyn_projectteam.md).
5. Atribuiți membri de echipă de proiect la activități. Pentru mai multe informații, consultați [msdyn_resourceassignment](../developer/entities/msdyn_resourceassignment.md).
