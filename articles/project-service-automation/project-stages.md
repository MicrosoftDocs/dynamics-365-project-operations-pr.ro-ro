...
---
# <a name="project-stages"></a>Etape de proiect 

[!INCLUDE[cc-applies-to-psa-app-3.x](../includes/cc-applies-to-psa-app-3x.md)]

Etapele proiectului sunt actualizate pentru a reflecta starea proiectului pe măsură ce progresează. Fluxul implicit de business actualizează automat unele etape etapele proiectului, în timp ce altele sunt actualizate manual de managerul de proiect. 
