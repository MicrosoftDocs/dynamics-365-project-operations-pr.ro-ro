...
---
# <a name="manage-a-proforma-invoice"></a>Gestionarea unei facturi proforma
...
| **Firmă de resurse** | Setați implicit din sursa reală. Un câmp numai pentru citire care este blocat de la editare. | Câmpul poate fi editat pe un nou detaliu al liniei de facturare care nu este susținut de o sursă reală. |
