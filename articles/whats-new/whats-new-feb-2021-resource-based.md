...
description: Acest articol oferă informații despre actualizările de calitate disponibile în lansarea din februarie 2021 a Project Operations pentru scenarii bazate pe resurse/care nu există pe stoc.
author: sigitac
ms.date: 02/08/2021
ms.topic: article
ms.prod: ''
...
Pentru mai multe informații despre Management de proiect și contabilitate în Dynamics 365 Finance, consultați [Ce este nou, ianuarie 2021 - Scenarii Project Operations bazate pe resurse/ne-stocate](whats-new-jan-2021-resource-based.md).
