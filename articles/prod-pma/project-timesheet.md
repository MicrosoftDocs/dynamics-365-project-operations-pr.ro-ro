...
description: Acest articol oferă informații despre aplicația mobilă Microsoft Dynamics 365 Project Timesheet. Aplicația mobilă Project Timesheet permite utilizatorilor să trimită și să aprobe foi de pontaj pentru proiecte pe dispozitivul lor mobil.
author: abruer
ms.date: 06/29/2022
ms.topic: article
ms.prod: ''
...
Aplicația mobilă Microsoft Dynamics 365 Project Timesheet permite utilizatorilor să trimită și să aprobe foi de pontaj pentru proiecte pe dispozitivul lor mobil (iPhone sau Android). Această aplicație mobilă prezintă funcționalitatea foii de pontaj care se află în zona de Management și contabilitate a proiectului din Dynamics 365 Finance. Ajută la îmbunătățirea productivității și eficienței utilizatorilor și, de asemenea, permite introducerea și aprobarea în timp util a foilor de pontaj ale proiectului.
...
### <a name="resolve-sign-in-issues"></a>Rezolvarea problemelor de conectare

**Problema:** În timpul conectării la aplicația Project Timesheet Mobile, utilizatorii primesc un mesaj de eroare care afirmă că „nu pot accesa aplicația”2bc50526-cdc3-4e36-a970-c284c34cbd6e' în acea entitate găzduită."

**Problema:** În timpul conectării la aplicația Project Timesheet Mobile, utilizatorii primesc o eroare care este similară cu unul dintre următoarele exemple:

- „AADSTS50020: Contul de utilizator „[nume utilizator]” de la furnizorul de identitate „https://sts.windows.net/[id aplicație]” nu există în entitatea găzduită „[id entitate găzduită]” și nu poate accesa aplicația „[id aplicație]” din acea entitate găzduită.”
- „Contul de utilizator selectat nu există în entitatea găzduită '[id entitate găzduită]' și nu poate accesa aplicația '[id aplicație]' în acea entitate găzduită.”

**Explicaţie:** Aceste probleme sunt cauzate de o modificare care a fost făcută în Azure Active Directory (Azure AD), în mai 2022, și care are legătură cu utilizatorii externi. Întrucât această modificare nu a fost adusă aplicațiilor pentru finanțe și operațiuni, poate afecta clienții pe orice versiune a platformei sau a aplicației.

**Rezolvare:** Toți utilizatorii externi trebuie invitați la entitatea găzduită prin Azure AD. Pentru mai multe informații, consultați [Invitare utilizatori cu Azure Active Directory B2B collaboration](/power-platform/admin/invite-users-azure-active-directory-b2b-collaboration).
...
În câmpul **Proiect**, selectați proiectul pentru care introduceți timpul. Câmpul **Client** este completat automat.
