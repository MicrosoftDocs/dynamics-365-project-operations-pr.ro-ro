...
description: Acest articol oferă informații despre actualizările de calitate care sunt disponibile în versiunea din septembrie 2021 a Project Operations pentru scenariile stocate/bazate pe producție.
author: andchoi
ms.date: 11/11/2021
ms.topic: article
ms.prod: ''
...
| Management de proiect și contabilitate | [570731](https://fix.lcs.dynamics.com/Issue/Details/?bugId=570371) | Aprobarea jurnalului orelor proiectului nu funcționează. |
...
| Management de proiect și contabilitate | [577598](https://fix.lcs.dynamics.com/Issue/Details/?bugId=577598) | Prețul de vânzare de proiect pe o comandă de achiziție de proiect facturată este calculat incorect atunci când modelul de preț de vânzare este **Raportul de contribuție**. |
...
| Management de proiect și contabilitate | [584519](https://fix.lcs.dynamics.com/Issue/Details/?bugId=584519) | Starea unei foi de pontaj nu poate fi actualizată la **Proiect** când fluxul de lucru este blocat într-un **Anulat** stat. |
...
| Deplasări și cheltuieli | [574489](https://fix.lcs.dynamics.com/Issue/Details/?bugId=574489) | Informațiile privind data publicată lipsesc pentru rapoartele de cheltuieli publicate. |
